...
echo "  Storage path: ${MODEL_STORAGE_PATH:-/workspace/models}"
echo ""
...
if [ $? -ne 0 ]; then
    ...
    echo ""
    echo "To fix this:"
    echo "  1. SSH into a RunPod pod with the persistent volume mounted at /workspace"
    echo "  2. Set HF_TOKEN environment variable"
    echo "  3. Set MODEL_STORAGE_PATH=/workspace/models"
...
echo "=========================================="
echo ""
echo "Models verified at: ${MODEL_STORAGE_PATH:-/workspace/models}"
echo ""
